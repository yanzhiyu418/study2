...
//为了让程序能够回来，使用循环实现
    ...
    private static void deletStudent(ArrayList<Student> array) {
        //键盘录入要删除的学生学号，显示提示信息
        Scanner sc = new Scanner(System.in);
        ...
        if (index == -1) {
            ...
            array.remove(index);
            System.out.println("删除学号为" + index + "的学生成功！");
        }
        //遍历集合将对应的学生对象从集合中删除
        /*
               for (int i=0;i<array.size();i++){
...
*/
    ...
    private static boolean isUse(ArrayList<Student> array,String sid) {
